WorldgenEvents.remove(event => {
	event.removeOres(ores => {
	  ores.blocks = [
					...
					'undead_revamp2:inducerstoneinactive',
					'undead_revamp2:somnolencespawns',
	...
	event.removeFeatureById('lakes', ['lake_lava_surface'])
  	event.removeFeatureById('underground_structures', 'minecraft:dungeon')
})